...
export function buildTenantFromApi(apiTenant: TenantApiData): Tenant {
  ...
  return {
    ...
    deliveryStrategy: apiTenant.deliveryStrategy as Tenant["deliveryStrategy"],
    deliveryBaseFee: apiTenant.deliveryBaseFee,
    deliveryPerKm: apiTenant.deliveryPerKm,
    deliveryFreeThreshold: apiTenant.deliveryFreeThreshold,
    deliveryMinOrder: apiTenant.deliveryMinOrder,
    deliveryMaxDistanceKm: apiTenant.deliveryMaxDistanceKm,
