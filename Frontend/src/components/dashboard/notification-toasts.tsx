...
/**
 * Toast notifications that appear in the bottom-right corner when new orders arrive.
    ...
    <div className="fixed bottom-6 right-6 z-[100] flex flex-col gap-2 pointer-events-none">
      <AnimatePresence>
        {toasts.map((toast) => (
          ...
          >
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#083d77] flex-shrink-0">
