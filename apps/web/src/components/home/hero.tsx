      ...
      <div className="relative grid gap-8 p-6 md:p-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
        ...
        <div className="space-y-7">
          ...
          >
            ...
            Plataforma publicitaria multiempresa para Cañete
          </motion.div>
          ...
          >
            ...
            <p className="max-w-xl text-lg leading-7 text-slate-600">
              Hoteles, restaurantes, tours, eventos y delivery en una sola plataforma. Tu negocio al
              frente de miles de clientes — mientras más inviertas, más visible serás.
            </p>
          </motion.div>
          ...
          >
            <div className="flex flex-1 items-center gap-3 rounded-2xl bg-slate-50 px-4 py-3">
              ...
              <input
                ...
                placeholder="Buscar restaurantes, hoteles, tours..."
              />
            </div>
            <div className="flex items-center gap-3 rounded-2xl bg-slate-50 px-4 py-3">
              <MapPin className="h-5 w-5 text-slate-400" />
              <input
                className="w-full bg-transparent text-sm text-ink outline-none placeholder:text-slate-400 sm:w-32"
                placeholder="Cañete"
              />
            </div>
            <button
              type="submit"
              className="rounded-2xl bg-coral px-6 py-3 text-sm font-semibold text-white transition hover:bg-coral/90 hover:shadow-lg"
            >
              Buscar
            </button>
          </motion.form>
          ...
          >
            {[
              ...
              { label: "🏨 Hoteles", v: "stay" },
              { label: "🧭 Tours", v: "tour" },
              { label: "🛵 Delivery", v: "delivery" },
            ].map((t) => (
              <button
                key={t.v}
                type="button"
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute -top-3 left-4 z-10 inline-flex items-center gap-1.5 rounded-full bg-coral px-3 py-1.5 text-xs font-bold text-white shadow-lg">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className={`relative h-56 bg-gradient-to-br ${current.accent} md:h-64`}>
                ...
                <div className="absolute left-4 top-4 inline-flex items-center gap-1 rounded-full bg-coral px-3 py-1 text-xs font-bold text-white">
                  PATROCINADO
                </div>
                <div className="absolute bottom-4 left-4 right-4 flex items-end justify-between text-white">
                  ...
                  <div className="inline-flex items-center gap-1 rounded-full bg-white/90 px-3 py-1.5 text-sm font-bold text-ink">
              ...
              <div className="space-y-4 p-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <p className="text-sm text-slate-500">
                    <span className="font-bold text-ink">S/ {current.priceFrom}</span> desde
                  </p>
                </div>
                <Link
                  href={`/marketplace`}
                  className="block rounded-2xl bg-ink py-3 text-center text-sm font-semibold text-white transition hover:bg-ink/90"
                >
                  Ver negocio →
                </Link>
              </div>
              ...
              {heroSlides.map((h, i) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all ${
                    i === slide ? "w-6 bg-coral" : "w-2 bg-slate-300"
                  }`}
